...
abstract class AbstractPage 
{
	...
	protected function getNavigationData() 
    {
      ...
      $resourceTable[$resourceID]['daily']            = (((Config::get($resource[$resourceID].'_basic_income') * $resourceSpeed)) + $PLANET[$resource[$resourceID].'_perhour']) * 24 ;
      $resourceTable[$resourceID]['weekly']            = (((Config::get($resource[$resourceID].'_basic_income') * $resourceSpeed)) + $PLANET[$resource[$resourceID].'_perhour']) * 168;
            if($USER['urlaubs_modus'] == 1 || $PLANET['planet_type'] != 1)
            {
                $resourceTable[$resourceID]['production']    = $PLANET[$resource[$resourceID].'_perhour'];
        $resourceTable[$resourceID]['dailyProduction']            = $PLANET[$resource[$resourceID].'_perhour'];
        $resourceTable[$resourceID]['weeklyProduction']            = $PLANET[$resource[$resourceID].'_perhour'];
            }
            else
            {
      ...
      $resourceTable[$resourceID]['daily']            = 0;
      $resourceTable[$resourceID]['weekly']            = 0;
        }
