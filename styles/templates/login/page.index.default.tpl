...
<section>
	...
	<p class="desc"><b>{$LNG.ov_player_online}: <font color="yellow">{$user_info_online}</font></b></p>
</section>
<section>
		...
		<tr class="contentbox-content">
			<td class="contentbox-content-left"></td><td class="contentbox-content-center">
				...
				<form id="login" name="login" action="index.php?page=login" data-action="index.php?page=login" method="post">
					...
					<div class="row">
						<label for="remember_pass">{$LNG.remember_pass}</label>
						<input name="remember_pass" id="remember_pass" type="checkbox" checked>
					</div>
					<div class="row">
