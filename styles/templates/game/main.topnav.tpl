						...
						<table id="resourceTable">
							<tbody>
								...
								<tr>
                                    ...
                                    {else}
                                    <td class="res_current tooltip" id="current_{$resouceData.name}" data-real="{$resouceData.current}" data-tooltip-content="
              <span>Produc {$resouceData.name}</span><br /><br />
              Production daily: {$resouceData.daily|number}<br />
              Production weekly: {$resouceData.weekly|number}">{$resouceData.current|number}</td>
                                    {/if}
                                    {/foreach}
                                </tr>
								<tr>
								...
								<tr>
                                    ...
                                    {else}
                                    <td class="res_current tooltip" id="current_{$resouceData.name}" data-real="{$resouceData.current}" data-tooltip-content="
									{$LNG.rs_daily} {$resouceData.daily|number}<br />
									{$LNG.rs_weekly} {$resouceData.weekly|number}">{$resouceData.current|number}</td>
                                    {/if}
                                    {/foreach}
								</tr>
								<tr>
                                    ...
                                    <td>&nbsp;</td>
                                    {else}
                                    <td class="res_max tooltip" id="max_{$resouceData.name}" data-real="{$resouceData.current}" data-tooltip-content="
									{$LNG.rs_daily} {$resouceData.daily|number}<br />
									{$LNG.rs_weekly} {$resouceData.weekly|number}">{$resouceData.max|number}</td>
                                    {/if}
                                    {/foreach}
								</tr>
								{/if}
