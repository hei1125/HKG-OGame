		...
		<tr>
			<td style="width:70%;vertical-align:top;" class="left">
				...
				<form class="build_form" action="game.php?page=buildings" method="post">
					...
					<input type="hidden" id="building_anz{$ID}" name="building_anz" value="1" style="width:20px;">
				 ...
				 {if $modinstant == 1 && $modinstantbuilds == 1}  
					...
					{else}
						<form action="game.php?page=buildings" method="post" class="post">
                            ...
                            <button type="submit" class="buttonbau greenbau" enabled>{$LNG.instant_buildings}</button>
						</form>
					{/if}{/if}
				{else}
			</td>
